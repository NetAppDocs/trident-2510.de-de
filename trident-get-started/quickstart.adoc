...
[role="lead"]
Sie können Trident installieren und in wenigen Schritten mit der Verwaltung von Speicherressourcen beginnen. Bevor Sie beginnen, lesen Sie link:../trident-get-started/requirements.html["Trident-Anforderungen"].
