...
summary: Trident läuft als einzelner Controller-Pod plus ein Node-Pod auf jedem Worker-Knoten im Cluster. Der Node-Pod muss auf jedem Host ausgeführt werden, auf dem potenziell ein Trident-Volume eingebunden werden soll. 
---
= Trident-Architektur
:hardbreaks:
:allow-uri-read: 
