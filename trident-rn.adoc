...
* *Openshift*:
+
** Behoben: Trident-Node-Pod startete auf Windows-Nodes in Openshift nicht, weil SCC allowHostDirVolumePlugin auf false gesetzt war (link:https://github.com/NetApp/trident/issues/950["Issue #950"]).
...
IMPORTANT: Für Kunden, die SolidFire verwenden, bitte nicht auf 25.06.1 aktualisieren, da es ein bekanntes Problem beim Unveröffentlichen von Volumes gibt. 25.06.2 wird in Kürze veröffentlicht, um dieses Problem zu beheben.
...
** Das Problem wurde behoben, bei dem Multipath-Sitzungen während eines ONTAP Failover-Givebacks nicht wiederhergestellt werden konnten (link:https://github.com/NetApp/trident/issues/961["Problem Nr. 961"]).
...
* iSCSI-Verbindungsstatus-Erkennung und Protokollierung hinzugefügt, wenn iSCSI-Sitzungen protokolliert sein sollten, es aber nicht sind (link:https://github.com/NetApp/trident/issues/961["Problem Nr. 961"]).
...
* *Kubernetes*:
+
** Fehlende Knoten-IP-Adressen aus automatischen Exportrichtlinien wurden korrigiert (link:https://github.com/NetApp/trident/issues/965["Problem Nr. 965"]).
...
** Hinzugefügt securityContext für den csi-resizer-Container (link:https://github.com/NetApp/trident/issues/976["Problem Nr. 976"]).
...
* Abmeldungen für zeitweise fehlerhafte Nicht-CHAP-Portale während der iSCSI Selbstreparatur entfernt (link:https://github.com/NetApp/trident/issues/961["Problem Nr. 961"]).
...
* Zusätzliche Protokollierung zur Fehlerbehebung hinzugefügt `lsscsi` (link:https://github.com/NetApp/trident/issues/792["Problem Nr. 792"]).
...
** Behoben tridentControllerPluginNodeSelector/tridentNodePluginNodeSelector funktioniert nicht mit dem Wert "true" (link:https://github.com/NetApp/trident/issues/899["Problem Nr. 899"]).
...
* **WICHTIG**: Der  `limitVolumeSize` Parameter begrenzt nun die qtree-/LUN-Größen in den ONTAP economy-Treibern. Verwenden Sie den neuen  `limitVolumePoolSize` Parameter, um die FlexVol-Größen in diesen Treibern zu steuern. (link:https://github.com/NetApp/trident/issues/341["Problem Nr. 341"]).
...
* Die Priorität des Trident-Controllers `SecurityContextConstraint` wurde auf `0` (link:https://github.com/NetApp/trident/issues/887["Problem Nr. 887"]) geändert.
...
* Falsche Protokollierungsebene während Volume-Mount-Operationen behoben (link:https://github.com/NetApp/trident/issues/781["Problem Nr. 781"]).
...
* Tech-Preview: Automatische MetroCluster-Umschaltungserkennung zu ONTAP-Treibern hinzugefügt. (link:https://github.com/NetApp/trident/issues/228["GitHub issue Nr. 228"^])
...
* Problem beim Aufheben der Veröffentlichung von Volumes auf gelöschten Knoten behoben. (link:https://github.com/NetApp/trident/issues/691["GitHub issue Nr. 691"^])
...
* *Kubernetes*: Trident Daemonset läuft jetzt mit der Prioritätsklasse „system-node-critical“. (link:https://github.com/NetApp/trident/issues/694["GitHub issue Nr. 694"^])
...
** Fügen Sie Planungsoptionen für Trident Pods hinzu, wenn diese über Trident Operator oder Helm installiert werden. (link:https://github.com/NetApp/trident/issues/651["GitHub issue Nr. 651"^])
