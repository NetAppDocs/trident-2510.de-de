...
.Was Sie benötigen
Siehe die link:prereqs-docker.html["Voraussetzungen für die Bereitstellung"]. Nachdem Sie sichergestellt haben, dass die Voraussetzungen erfüllt sind, sind Sie bereit, Trident bereitzustellen.
