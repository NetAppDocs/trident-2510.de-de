...
`300`
 ...
 a| 
`sanType`
| *Unterstützt nur für `ontap-san`-Treiber.* Verwenden Sie zur Auswahl von `iscsi` für iSCSI, `nvme` für NVMe/TCP oder `fcp` für SCSI über Fibre Channel (FC). | `iscsi` falls leer 
...
Weitere Informationen zu FlexGroups und Arbeitslasten, die für FlexGroups geeignet sind, finden Sie im  https://www.netapp.com/pdf.html?item=/media/12385-tr4571pdf.pdf["NetApp FlexGroup Volume Best Practices und Implementierungsleitfaden"^].
