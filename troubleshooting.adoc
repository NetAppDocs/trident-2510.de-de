...
* Ein häufiges Problem, auf das Sie bei der Verwendung von Trident mit https://azure.microsoft.com/en-us/services/netapp/["Azure NetApp Files"] stoßen könnten, ist, wenn die Mandanten- und Clientgeheimnisse aus einer App-Registrierung mit unzureichenden Berechtigungen stammen. Eine vollständige Liste der Trident-Anforderungen finden Sie unter link:trident-use/anf.html["Azure NetApp Files"]Konfiguration.
