...
Auf allen Ihren Kubernetes-Worker-Knoten müssen die entsprechenden iSCSI-Tools installiert sein. Weitere Informationen finden Sie unter link:worker-node-prep.html["Bereiten Sie den Worker-Knoten vor"].
