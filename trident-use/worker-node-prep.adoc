...
. Ermitteln Sie die WWPN der Zielschnittstellen. Weitere Informationen finden Sie unter  https://docs.netapp.com/us-en/ontap-cli//network-interface-show.html["Netzwerkschnittstelle anzeigen"^].
