...
* Besuchen Sie link:https://cloud.netapp.com/blog/astra-blg-sharing-volumes-between-namespaces-say-hello-to-cross-namespace-volume-access["Gemeinsame Nutzung von Volumes zwischen Namespaces: Sagen Sie Hallo zum namespace-übergreifenden Volume-Zugriff"^].
