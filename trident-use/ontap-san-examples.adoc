...
Kann so konfiguriert werden, dass IPv6-Adressen verwendet werden, wenn Trident mit dem IPv6-Flag installiert wurde. IPv6-Adressen müssen in eckigen Klammern definiert werden, wie  `[28e8:d9fb:a825:b7bf:69a8:d02f:9e7b:3555]`.
...
| `luksEncryption` | Aktivieren Sie die LUKS-Verschlüsselung. Siehe link:../trident-reco/security-luks.html["Verwenden Sie Linux Unified Key Setup (LUKS)"]. | "" *Auf  `false` für ASA r2-Systeme setzen*. 
