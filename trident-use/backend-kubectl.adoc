...
. Erstellen Sie ein  `TridentBackendConfig` Objekt. Dieses enthält spezifische Informationen über den Speichercluster/Dienst und verweist auf das im vorherigen Schritt erstellte Geheimnis.
