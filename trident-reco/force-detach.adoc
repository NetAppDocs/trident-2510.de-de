...
NOTE: Sie können auch alternative Methoden zur Erkennung von Knotenausfällen verwenden, wie im link:force-detach.html#integrating-custom-node-health-check-solutions["Integration kundenspezifischer Lösungen zur Überprüfung des Knotenzustands"] Abschnitt unten angegeben.
