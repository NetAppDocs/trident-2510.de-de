...
.Schritte
. Erstellen Sie auf dem Quell-Cluster ein AppVault für die Quellanwendung. Je nach Speicheranbieter passen Sie ein Beispiel in link:trident-protect-appvault-custom-resources.html["AppVault benutzerdefinierte Ressourcen"] an Ihre Umgebung an:
+
[role="tabbed-block"]
====
