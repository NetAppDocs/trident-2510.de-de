...
* Stellen Sie sicher, dass mindestens eine VolumeSnapshotClass existiert. Weitere Informationen finden sich unter link:../trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"].
